...
class CartMethods
{
  addItemToCart(String? itemId, int itemCounter, BuildContext context) async
  {
  ...
  //2367121:5 ==> 2367121
  separateItemIDsFromUserCartList()async
  {
  //2367121:5
  ...
  //2367121:5 ==> 5
  separateItemQuantitiesFromUserCartList()async
  {    //2367121:5
    List<String>? userCartList =await sharedPreferences!.getStringList("userCart");
    print("userCartList = ");
    print(userCartList);
